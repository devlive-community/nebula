  ...
  zh: {
    ...
    features: {
      ...
      items: {
        ...
        browse: {title: '高效浏览', desc: '目录逐层展开、列表 / 网格视图、排序过滤、图片视频预览、文件夹 / Bucket 大小统计;对象详情含存储类型与真实 Content-Type(可改),单个对象或整个文件夹都能转换存储层、取回归档。'},
  ...
  en: {
    ...
    features: {
      ...
      items: {
        ...
        browse: {title: 'Fast browsing', desc: 'Drill into folders, list / grid views, sort and filter, image & video preview, folder / bucket size stats; object details incl. storage class and the real Content-Type (editable), with tier transition and archive restore for a single object or a whole folder.'},
