  ...
  zh: {
    ...
    features: {
      ...
      items: {
        ...
        download: {title: '流式下载', desc: '边下边写,大文件不占内存;支持断点续传、整文件夹递归下载,每个任务独立进度。'},
  ...
  en: {
    ...
    features: {
      ...
      items: {
        ...
        download: {title: 'Streaming download', desc: 'Stream to disk without buffering huge files; resumable downloads and whole-folder recursive download with per-task progress.'},
