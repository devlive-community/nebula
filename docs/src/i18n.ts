...
const messages = {
  zh: {
    ...
    hero: {
      ...
      title1: '一个界面,管理你的',
      title2: '多云对象存储',
      subtitle: '在一个原生桌面应用里管理阿里云 OSS、腾讯云 COS、华为云 OBS、AWS S3、Cloudflare R2、七牛 Kodo、MinIO、Backblaze B2、Wasabi、DigitalOcean Spaces、Scaleway Object Storage、UCloud US3、京东云 OSS —— 浏览、上传下载、分享、跨云迁移,一站搞定。轻量、快速,macOS / Windows / Linux 原生三端。',
      download: '立即下载',
      github: '在 GitHub 查看'
    },
    preview: {
