  ...
  zh: {
    ...
    features: {
      ...
      items: {
        ...
        sync: {title: '备份与同步', desc: '把本地目录与云端前缀对起来,做备份 / 还原 / 双向同步;先给逐文件 diff 预览(将上传 / 下载 / 删除哪些、共需传多少),确认再执行;支持 glob 排除规则(如 .DS_Store、node_modules/**)、实时进度与随时取消,并复用续传、秒传跳过与限速。'},
