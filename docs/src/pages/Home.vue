...
const brands = ['Aliyun OSS', 'Tencent COS', 'Huawei OBS', 'AWS S3', 'Cloudflare R2', 'Qiniu Kodo', 'MinIO', 'Backblaze B2', 'Wasabi', 'DigitalOcean Spaces', 'Scaleway Object Storage', 'UCloud US3', 'JD Cloud OSS']
