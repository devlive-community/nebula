...
export const EN: Record<string, string> = {
  ...
  "{n} 小时前": "{n} h ago",
  "{n} 天前": "{n} d ago",
  "定时同步「{name}」完成:{result}": "Scheduled sync “{name}” done: {result}",
  "定时同步「{name}」失败:{msg}": "Scheduled sync “{name}” failed: {msg}",
  "每 {n} 分钟": "Every {n} min",
  ...
  批量标签: "Batch tags",
  "批量移动 / 复制": "Move / copy",
  "移动 / 复制 {n} 项到": "Move / copy {n} items to: ",
  "✓ 已移动 {n} 项": "✓ Moved {n} items",
  "✓ 已复制 {n} 项": "✓ Copied {n} items",
  批量公开: "Make public",
  批量私有: "Make private",
  "✓ 已把 {n} 项设为公开读": "✓ Made {n} items public",
  "✓ 已把 {n} 项设为私有": "✓ Made {n} items private",
  "批量标签({n} 项)": "Batch tags ({n} items)",
  "保留各对象已有的其它标签(合并)": "Keep each object's other tags (merge)",
  应用标签: "Apply tags",
  替换标签: "Replace tags",
  请至少填一个标签键: "Enter at least one tag key",
  "✓ 已给 {n} 项打标签": "✓ Tagged {n} items",
  "导出清单 CSV": "Export manifest CSV",
  "✓ 已导出清单": "✓ Manifest exported",
  "共 {n} 个文件 · {b}": "{n} files · {b} total",
  该目录没有文件: "No files in this folder",
  "扫描中…": "Scanning…",
  未发现重复文件: "No duplicates found",
  "{g} 组重复 · 可回收 {b}": "{g} duplicate groups · {b} reclaimable",
  "(已达扫描上限)": "(scan limit reached)",
  "{n} 个副本 · 每个 {s} · 冗余 {w}": "{n} copies · {s} each · {w} redundant",
  保留: "keep",
  "删除中…": "Deleting…",
  "删除选中 {n} 个(省 {b})": "Delete {n} selected (save {b})",
  "确认删除选中的 {n} 个副本?此操作不可撤销。":
    "Delete the {n} selected copies? This cannot be undone.",
