...
> 已实现阿里云 OSS、华为云 OBS(均真账号验证过)、七牛云 Kodo 与 AWS S3(后两家 S3 兼容,
> 共用 `s3-core`,离线单测全绿、真账号冒烟待验证)。新增厂商 = 按
...
- 厂商规格卡 `docs/sdk/<crate>.md` — 每家特有的签名/endpoint/进度(见 [aliyun-oss](./docs/sdk/aliyun-oss.md)、[huawei-obs](./docs/sdk/huawei-obs.md)、[qiniu-kodo](./docs/sdk/qiniu-kodo.md)、[aws-s3](./docs/sdk/aws-s3.md),新建用 [_template](./docs/sdk/_template.md))
